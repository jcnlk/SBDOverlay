import { indexToFloor } from "../util/calc";
import { handleError } from "../util/error";
import { requestUUID, requestStats } from "../util/requests";
...
export default class PartyMember {
  ...
  updateSecretAverage() {
    if (this.dungeons.secrets && this.dungeons.runs) this.dungeons.secretAverage = (parseInt(this.dungeons.secrets) / this.dungeons.runs).toFixed(1);
  }
