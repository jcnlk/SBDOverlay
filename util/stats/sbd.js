...
const transformFunc = (data) => {
  const obj = { dungeons: data.dungeons };
...
export const statsSbdCf = { urlFunc: urlFuncCf, transformFunc, key: "stats-sbd-cf" };
export const statsSbdAz = { urlFunc: urlFuncAz, transformFunc, key: "stats-sbd-az" };